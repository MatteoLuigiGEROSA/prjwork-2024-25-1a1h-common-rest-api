...
class BulkImportExport1H(Resource):
    """
    ...
    def get(self):
        ...
        try:
            ...
            db = current_app.config['firebase'].get('db_app_1h')
            ...
            error_location = "BulkImportExport1H.get"
    ...
    def post(self):
        ...
        try:
            ...
            required_keys = ["passaggioLivello"]
            ...
            error_location = "BulkImportExport1H.post"
    ...
    def delete(self):
        ...
        try:
            ...
            error_location = "BulkImportExport1H.delete"
